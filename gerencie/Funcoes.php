...
function selectValidaCpf($replace)
{

    include 'connect-sqlsrv.php';

    $queryValidaCPF = "SELECT 
    --COUNT(*) NUM
        EMAIL,
        CPF,
        RA,
    ...
    WHERE
        ...
        ) Alunos WHERE CPF = '$replace'";

    $queryExecValCPF = $pdo_sqlsrv->prepare($queryValidaCPF);
    $queryExecValCPF->execute();

    $linha = $queryExecValCPF->fetch(PDO::FETCH_ASSOC);
